...
class LogbookScreen extends ConsumerStatefulWidget {
  ...
  const LogbookScreen(
      {super.key, this.isEdit = false, this.currentIndex = 0});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(isEditing ? 'Edit Register Entry' : 'New Register Entry'),
      ),
      body: ListView(
        ...
        children: [
          ...
          _buildModule([
            _field(
              ...
              ctrl: _idCtrl,
              hint: 'e.g. TCB-DENT-1890-LONDON-022',
              isMono: true,
              onChanged: (v) =>
                  ref.read(inputProvider).temporalIdentifier = v,
            ),
            _field(
              ...
              hint: 'e.g. E. Dent & Co.',
              onChanged: (v) =>
                  ref.read(inputProvider).manufacturerAndMaker = v,
            ),
          ...
          _buildModule([
            _field(
              ...
              isMono: true,
              onChanged: (v) =>
                  ref.read(inputProvider).precisionRating = v,
            ),
          ...
          _buildModule([
            ...
            _field(
              ...
              ctrl: _accCtrl,
              hint: 'e.g. Original wooden case, calibration weights',
              maxLines: 2,
              onChanged: (v) =>
                  ref.read(inputProvider).includedAccessories = v,
            ),
            _field(
              label: 'Marks & Signatures',
              ctrl: _markCtrl,
              hint: 'e.g. Royal Navy broad arrow, observatory marks',
              isMono: true,
              maxLines: 2,
              onChanged: (v) =>
                  ref.read(inputProvider).markingsAndStamps = v,
            ),
            _field(
              label: 'Chain of Custody',
              ctrl: _provCtrl,
              hint: 'e.g. Greenwich Observatory, HMS Victory',
              maxLines: 2,
            ...
            _field(
              ...
              ctrl: _tagsCtrl,
              hint: 'e.g. observatory, naval, brass',
              isMono: true,
              onChanged: (v) =>
                  ref.read(inputProvider).tags = v.split(',').map((e) => e.trim()).where((e) => e.isNotEmpty).toList(),
            ),
          ]),
            ...
            : Column(
                ...
                children: [
                  Icon(Icons.camera_alt_outlined,
                      color: kSecondaryText, size: 36.sp),
                  SizedBox(height: 8.h),
                  Text(
                    'Capture Plate',
                  ...
                  Text(
                    'Instrument documentation recommended',
                    style: GoogleFonts.sourceSans3(
          ...
          TextField(
            ...
            style: isMono
                ? GoogleFonts.ibmPlexMono(
                    color: kPrimaryText, fontSize: 13.sp)
                : GoogleFonts.sourceSans3(
                    color: kPrimaryText, fontSize: 14.sp),
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 6.w,
          runSpacing: 6.h,
          children: InstrumentType.values
              .map(
                (t) => GestureDetector(
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 6.w,
          runSpacing: 6.h,
          children: CountryOfOrigin.values
              .map(
                (c) => GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    padding:
                        EdgeInsets.symmetric(horizontal: 10.w, vertical: 6.h),
                    decoration: BoxDecoration(
                      color: p.countryOfOrigin == c
                          ? kWalnut.withAlpha(20)
                          : kBackground,
                      borderRadius: BorderRadius.circular(kRadiusPill),
                      border: Border.all(
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 6.w,
          runSpacing: 6.h,
          children: OperatingPrinciple.values
              .map(
                (o) => GestureDetector(
